package com.example.myapplication.kline.units;
...
import com.example.myapplication.kline.draw.KDJDraw;
import com.example.myapplication.kline.draw.MACDDraw;
import com.example.myapplication.kline.draw.MainDraw;
import com.example.myapplication.kline.draw.RSIDraw;
import com.example.myapplication.kline.draw.VolumeDraw;
import com.example.myapplication.kline.draw.WRDraw;
...
public class KLineChartView extends BaseKLineChartView {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                //public
                setPointWidth(array.getDimension(R.styleable.KLineChartView_kc_point_width, getDimension(R.dimen.dp_7)));
                setTextSize(array.getDimension(R.styleable.KLineChartView_kc_text_size, getDimension(R.dimen.sp_10)));
                setTextColor(array.getColor(R.styleable.KLineChartView_kc_text_color, getColor(R.color.chart_text)));
                setMTextSize(array.getDimension(R.styleable.KLineChartView_kc_text_size, getDimension(R.dimen.sp_10)));
                setMTextColor(array.getColor(R.styleable.KLineChartView_kc_text_color, getColor(R.color.lanse_s)));
                setLineWidth(array.getDimension(R.styleable.KLineChartView_kc_line_width, getDimension(R.dimen.dp_1)));
                ...
                setSelectedLineWidth(array.getDimension(R.styleable.KLineChartView_kc_selected_line_width, getDimension(R.dimen.dp_1)));
                setGridLineWidth(array.getDimension(R.styleable.KLineChartView_kc_grid_line_width, getDimension(R.dimen.dp_1)));
                setGridLineColor(array.getColor(R.styleable.KLineChartView_kc_grid_line_color, getColor(R.color.chart_grid_line)));
                //macd
                setMACDWidth(array.getDimension(R.styleable.KLineChartView_kc_macd_width, getDimension(R.dimen.dp_6)));
                ...
                setCandleWidth(array.getDimension(R.styleable.KLineChartView_kc_candle_width, getDimension(R.dimen.dp_6)));
                setCandleLineWidth(array.getDimension(R.styleable.KLineChartView_kc_candle_line_width, getDimension(R.dimen.dp_1)));
                ...
                setSelectorTextSize(array.getDimension(R.styleable.KLineChartView_kc_selector_text_size, getDimension(R.dimen.sp_12)));
    ...
    int startX1 = 0, startY1 = 0, moveX, moveY;
    @Override
    public boolean dispatchTouchEvent(MotionEvent ev) {
        int pCount = ev.getPointerCount();// 触摸设备时手指的数量
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                startX1 = (int) ev.getRawX();
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                int tempMoveX = Math.abs(moveX - startX1);
                int tempMoveY = Math.abs(moveY - startY1);
                if (tempMoveY != 0 && pCount == 2) {
                    getParent().requestDisallowInterceptTouchEvent(true );
                }else if(tempMoveX > tempMoveY * 0.5){
                    getParent().requestDisallowInterceptTouchEvent(true );
                }else{
                    getParent().requestDisallowInterceptTouchEvent(false );
                }
